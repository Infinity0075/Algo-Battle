  ...
  if (loading) {
    return (
      <div style={styles.centeredState}>
        ...
        <p style={styles.loadingText}>Fetching problem…</p>
      </div>
    )
  }
    ...
    <div style={styles.page}>
      ...
      <div style={styles.container}>
        ...
        <div style={styles.header}>
          ...
          <h1 style={styles.title}>Edit Problem</h1>
          <p style={styles.subtitle}>Refine and update the challenge</p>
        </div>
...
const styles = {
  ...
  ioRow: { display: 'flex', alignItems: 'flex-start', gap: 12 },
  ioArrow: { color: '#3a3a50', fontSize: 20, paddingTop: 34, flexShrink: 0 },
  actions: {
    display: 'flex',
    gap: 12,
